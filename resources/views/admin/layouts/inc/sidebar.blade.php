    ...
    <ul class="menu-inner py-1">
        @if (Auth::user()->role == 1)
            ...
            @elseif($routeName == 'business')
                ...
                <li class="menu-item {{ request()->routeIs('business.services', $slug) ? 'active' : '' }}">
                    <a href="{{ route('business.services', $slug) }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-dock-top"></i>
                ...
                <li class="menu-item {{ request()->routeIs('business.settings', $slug) ? 'active' : '' }}">
                    <a href="{{ route('business.settings', $slug) }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-dock-top"></i>
                        <div data-i18n="Account Settings">Settings</div>
                    </a>
                </li>
                <li class="menu-item {{ request()->routeIs('business.about', $slug) ? 'active' : '' }}">
                    <a href="{{ route('business.about', $slug) }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-dock-top"></i>
        ...
        @else
            ...
            <li class="menu-item {{ request()->routeIs('admin.business') ? 'active' : '' }}">
